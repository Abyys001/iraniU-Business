 ...
 *
 * نسخهٔ استاتیک: relayUrl خالی بماند؛ فقط ذخیرهٔ محلی.
 * اگر بعداً رلهٔ HTTP اضافه کردید: window.IRANIU_CHAT = { relayUrl: 'https://…/relay' };
 */
(function () {
  'use strict';
  ...
  function init() {
    ...
    form.addEventListener('submit', function (e) {
      ...
      if (!relayUrl) {
        statusEl.textContent = 'ذخیره شد (محلی و سرور).';
        return;
      }
